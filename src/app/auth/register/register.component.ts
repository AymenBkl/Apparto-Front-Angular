...
export class RegisterComponent implements OnInit {
  ...
  register(){
    if (this.registerForm.valid){
      this.submitted = true;
      this.authService.registerUser(this.registerForm.value,this.newUserAdd)
 ...
 detectNewUser() {
  this.activatedRouter.queryParamMap.subscribe(params => {
    if (params && params.get('newUser') && params.get('newUser') == 'true') {
      this.newUserAdd = true;
    }
  })
 }
}
